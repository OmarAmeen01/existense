...
<section className='mt-12  min-[1350px]:px-40  '>
        <Image className='object-cover w-full h-80  md:h-[645px]  max-[370px]:h-36 max-[460px]:h-52 rounded-lg ' src="/img8.webp" alt='product' width={100000} height={669}/>
</section>
