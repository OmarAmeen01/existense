...
<section className='justify-between flex flex-col-reverse lg:mx-16  min-[1640px]:mx-32  max-w-[1440px] min-[700px]:flex-row rounded-lg bg-[#F8F8F8] min[400px]:px-10 my-16  min-[700px]:mx-10 '>
