...
export default function page() {
  return (
     <main>
    <article className='px-2 min-[390px]:px-4 min-[1200px]:px-36 '>
    <header className='mt-16 md:w-[44rem] m-auto'>

<h1  className='font-sans font-[500] text-5xl min-[676px]:text-[56px] text-center  py-4'>About Us</h1>
<p className='text-center  font-sans  py-4 max-[400px]:px-4 text-lg md:w-[32rem] m-auto' >An initiative with very advanced and initiative technology, aiming in providing meaningful AI solutions</p>
</header>

<section className='mt-20  min-[1350px]:px-40 px-4 '>
        <Image className='object-cover w-full h-80  md:h-[508px]  rounded-lg shadow-2xl' src="/img6.jpg" alt='product' width={100000} height={669}/>
</section>
<section className='justify-between flex flex-col  md:flex-row rounded-lg bg-white px-3 min[400px]:px-10 my-28 mx-3'>
       
       <div className='  min-[676px]:flex min-[676px]:flex-col min-[676px]:justify-center min-[676px]:items-center   md:w-[20rem] lg:w-[34rem] 2xl:ml-52 md:mx-16 lg:mx-32 lg:max-w-[20rem] ' >
        <h3 className='font-sans 
    max-[450px]:text-[26px] text-3xl md:text-2xl lg:text-3xl min-md:mb-7 max-md:pt-12 font-[500]'>Our vision for the future of education.</h3>
        <p className='font-sans  py-4 max-[400px]:px-4 text-lg    
    ...
    <Image className=" w-full    max-md:mt-14 rounded-lg lg:w-[40rem] shadow-lg md:h-[448px] min-[1450px]:h-[600px]  max-w-full"    src='/img7.jpg' alt="vision" width={342} height={400} quality={100} style={{objectFit:"cover"}}/>
    </div>
    
</section>

<section className="mt-[72px] min-[676px]:mt-28 px-4 sm:px-10 md:px-40 min-[1200px]:px-72">
    <div >
        <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>The Company</h2>
    ...
    <div>
    <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>The Present</h2>
    <p className='font-sans text-lg py-4  '>
    ...
    <div>
    <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>The Possibility</h2><p className='font-sans text-lg py-4  '>
    ...
    <div>
    <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>How we can do it</h2>
    <p className='font-sans text-lg py-4  '>
    In over a decade of technological advancements, few industries hold as much transformative potential as education enhanced by AI. The future of personalized, scalable learning depends on overcoming significant challenges in technology and infrastructure. At Misty, we are heads-down and focused on making substantial advancements to achieve this vision. Here’s how we plan to get there:
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>1. Adaptive System Design:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>2. Accesibility and Affordability:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>3. Safety and Trustworthiness:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>4. Scalable Deployment:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>5. Advanced AI Capabilities:</h3>
            <p className='font-sans text-lg py-4  '>
...
<section className="mt-28 p-2 min-[500px]:p-10 rounded-lg mx-3 min-[500px]:mx-10 md:px-32 min-[1200px]:mx-20 min-[1200px]:px-52 bg-white ">
    <header className='mt-10'>
    <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>Conclusion</h2>
    <p className='font-sans text-lg py-4  '>
    ...
    <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>1. Build a Compreheve, AI-Powered Education Platform:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>2. Achieve Human-Like Interaction and Engagement:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h3 className='font-sans 
    max-[400px]:text-[26px] text-2xl min-md:mb-7 font-[500]'>3. Integrate this into Everyday Learning:</h3>
            <p className='font-sans text-lg py-4  '>
         ...
         <div className='mt-8'>
         <h2 className='font-sans 
    max-[400px]:text-[26px] text-3xl min-md:mb-7  pt-12 font-[500]'>It’s time to build.</h2>
         </div>
</section>
   <CallToAction/>
    </article>
