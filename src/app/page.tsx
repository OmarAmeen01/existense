...
<article>
  ...
  <video src="/videos/Main.mp4" autoPlay   loop preload="metadata" height={40}  muted className='w-full border-2 rounded-lg ml-auto mr-auto h-[90vh] object-cover'></video>
     ...
     <div className='relative grid gap-5 place-items-center'>
      ...
      <h1 className='font-sans text-center text-4xl lg:text-5xl  py-1 lg:py-4 text-white font-[600]'>
           Existense
        </h1>
        <p className='font-sans text-xl md:text-2xl text-white text-center '>Revolutionising The Education System Forever</p>
      </div >
