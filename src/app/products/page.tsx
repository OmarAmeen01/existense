...
<article>
    <header className='mt-12'>
        ...
        <h1 id='product-heading' className='font-sans font-[600] max-[470px]:text-3xl text-5xl min-[676px]:text-6xl   text-center tracking-tighter py-4'>Introducting Misty</h1>
        <p className='text-center text-lg font-sans px-12 p-4 min-[676px]:text-2xl'>The revolutionary AI tutor designed to transform how we learn.</p>
    </header>
    <section className='mt-12 px-11 min-[1350px]:px-40 md:px-20 lg:px-30  '>
    ...
    <section className='mt-[72px] sm:mt-20 '>
         <div className='px-20 md:px-[9rem] sm:px-[7rem] max-sm:px-[5rem] lg:px-[12rem]  max-[400px]:text-xl min-[1350px]:px-[17rem] text-2xl py-2 font-sans min-[1350px]:text-3xl '>
    ...
    <section className='mt-[72px] min-[676px]:mt-20 '>
            <h2 className='font-sans font-[600] text-center text-3xl sm:text-6xl tracking-tighter p-2 '>
            Key Features of Misty
            </h2>
<section className=' px-4 mt-[72px] lg:mt-28'>
{features.map(feature=>{
    return (
        <div className={`justify-between flex flex-col md:gap-5  rounded-lg  md:bg-white  mb-28 ${feature.style} `} key={feature.title}> 
...
<section className='mt-[72px] min-[676px]:mt-20 '>
    <header>
        <h2 className='font-sans font-[600] text-3xl sm:text-6xl  p-2 text-center '>Real Reviews</h2>
        <p className='font-sans text-lg min-[676px]:py-6 min-[676px]:text-2xl p-2 text-center'>Tested by 1000+ students.</p>
    </header>
   <section className=' h-[38rem]  overflow-hidden'>
  <div className="flex  wrapper">{reviews[0].map((review,index)=>{
    return (
        <div className={` itemLeft h-32 w-[28rem] bg-white   rounded-lg item${index}`} key={review.slice(0,4)}>
        
          <p className='font-sans text-lg p-4 min-[676px]:text-xl  '>{review}</p>
            
        </div>           
    )
  })}</div>
  <div className='flex mb-6 wrapper' >
  {reviews[1].map((review,index)=>{
    return (
        <div className={` itemRight min-[1350px]:h-32 min-[1350px]:w-[28rem]  h-22  w-[25rem] border-2 border-red-500  bg-white  rounded-lg  item${index}`}  key={review.slice(0,4)}>
        
          <p className='font-sans p-4  min-[676px]:text-xl'>{review}</p>
  ...
  {reviews[2].map((review,index)=>{
    return (
        <div className={` p-4 itemLeft h-32 w-[28rem]  bg-white  rounded-lg item${index}`} key={review.slice(0,4)}>
