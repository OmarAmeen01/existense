...
<article>
    ...
    <section className='mt-[72px] sm:mt-28'>
        ...
        <p>Misty is a first-of-its-kind AI tutor designed to transform how we learn. Misty is an emotionally Intelligent AI tutor that adapts to every student&appos;s unique learning style, pace ensuring no one is left behind. Misty is not just another online tutor providing recorded video lessons or same resources to each one; it’s a truly personalized AI who treats every student according to his or her grasping power and with that it designs modules so the child can learn at his pace.</p>
